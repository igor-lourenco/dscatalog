...
public class ProductServiceTests {
	...
	void setUp() throws Exception{
		...
		Mockito.when(repository.findAll((Pageable)ArgumentMatchers.any())).thenReturn(page);//Quando chamar o repository.findAll passando alguma coisa do tipo Pageable, faça o retorno de um página.
		
		Mockito.when(repository.save(ArgumentMatchers.any())).thenReturn(product); //Quando chamar o repository.save passando alguma coisa, salva o produto
